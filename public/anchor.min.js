        ...
        if ((u(this.options), 0 !== (e = d((A = A || 'h2, h3, h4, h5, h6'))).length)) {
          for (
            null === document.head.querySelector('style.anchorjs') &&
              ...
              void 0 === (h = document.head.querySelector('[rel="stylesheet"],style'))
            ...
            if (this.hasAnchorJSLink(e[i])) p.push(i);
              ...
              if (e[i].hasAttribute('id')) o = e[i].getAttribute('id');
                ...
                for (
                  ...
                  (n = t.indexOf((r = void 0 !== n ? a + '-' + s : r))), (s += 1), -1 !== n;
              ...
              ((l = document.createElement('a')).className = 'anchorjs-link ' + this.options.class),
                ...
                '' === this.options.icon &&
                  ((l.style.font = '1em/1 anchorjs-icons'), 'left' === this.options.placement) &&
