...
With the launch of E2E Visual Tests in public beta, we made some changes to Chromatic's setup process for [Playwright](/docs/playwright) and [Cypress](/docs/cypress). Follow this guide to upgrade and resume your visual tests.
