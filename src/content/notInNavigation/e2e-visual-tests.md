...
| Option                    | Type      | Description                                                                |
|---------------------------|-----------|----------------------------------------------------------------------------|
| `delay`                   | `number`  | [More information](/docs/delay/)                                           |
| `diffIncludeAntiAliasing` | `boolean` | [More information](/docs/threshold/#anti-aliasing)                         |
| `diffThreshold`           | `number`  | [More information](/docs/threshold/#setting-the-threshold)                 |
| `forcedColors`            | `string`  | [More information](/docs/media-features/#test-high-contrast-color-schemes) |
| `pauseAnimationAtEnd`     | `boolean` | [More information](/docs/animations/#css-animations)                       |
| `prefersReducedMotion`    | `string`  | [More information](/docs/media-features/#verify-reduced-motion-animations) |
