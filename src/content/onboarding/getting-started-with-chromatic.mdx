...
- If you are using SSO configured via your enterprise plan, you will visit your dedicated subdomain instead.
  - Reach out to your Chromatic CSM, Account Executive, or Technical Support if you are unsure of your subdomain.
...
- [On-prem GitHub or GitLab (Enterprise Only)](/docs/access/#how-do-i-link-my-project-to-github-enterprise-server-or-gitlab-self-managed)
  - Reach out to your Chromatic CSM, Account Executive, or Technical Support if you are interested in setting up on-prem git.
- Confirm that [Mandatory Status Checks](/docs/mandatory-pr-checks/#github) are configured.
  - This is a best practice to ensure that all PRs pass visual regression testing before they are merged.
    - This is setup via branch protection rules for GitHub and a default requirement to pass with GitLab and Bitbucket pipelines.
...
- We also have a [Storybook 9 Migration Guide](https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#from-version-8x-to-900)

## 6. Setup and Flags for CI
...
Here are some resources to help you get started:
    ...
    - [Chromatic with Monorepos](/docs/custom-ci-provider/#run-chromatic-on-monorepos)
    - [Chromatic using GitHub Actions](/docs/github-actions)
