...
See [Vitest's sharding documentation](https://vitest.dev/guide/improving-performance.html#sharding) for an example on how to merge Vitest's own test reports.
