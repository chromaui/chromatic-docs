...
{/* ![Set up project](../../images/vitest-setup.png) */}
...
{/* ![Chromatic build screen with a list of component tests that have visual changes](../../images/vitest-build-unreviewed.png) */}
...
{/* ![Clicking on a test takes you to the snapshot page where you can compare the new snapshot to the baseline](../../images/vitest-snapshot-unreviewed.png) */}
...
{/* ![Chromatic build screen with all changes approved](../../images/vitest-build-reviewed.png) */}
