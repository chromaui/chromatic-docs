...
These options control how Chromatic behaves when capturing snapshots of your pages. They can be set at the global, test file, test suite, or test case level (except where noted).
