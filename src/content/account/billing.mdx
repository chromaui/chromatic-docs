...
import { SnapshotCalculator } from "../../components/SnapshotCalculator";
...
For example, see how many snapshots are taken in different scenarios below. Or use the [snapshot calculator](/docs/billing#snapshot-calculator) to estimate your usage.
...
For the remaining stories, Chromatic captures new snapshots as usual and bills them at the regular rate. There are some examples below or jump to the [snapshot calculator](/docs/billing#snapshot-calculator) to estimate your usage.
