...
| TurboSnap                                                                      | The billed snapshot cost is 0.2 per copied snapshot. Bypassed snapshots generate 0 billed snapshots.                                         |
| `onlyStoryNames` / `onlyStoryFiles`                                            | Stories excluded by these options are billed at the copied snapshot rate of 0.2 billed snapshots per copied snapshot.                       |
