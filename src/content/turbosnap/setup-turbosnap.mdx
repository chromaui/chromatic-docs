...
<details>
  <summary>Does TurboSnap work with Playwright or Cypress?</summary>

No. TurboSnap works by monitoring which files changed, this isn't possible with Playwright and Cypress because these "black box testing" tools test your app after the code is built.
