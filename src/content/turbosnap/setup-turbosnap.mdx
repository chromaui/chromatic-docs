...
Place this script before the Chromatic command:
...
You must configure the Storybook builder directly within your [`angular.json` file](https://storybook.js.org/docs/get-started/frameworks/angular) by adding `"webpackStatsJson": true`.
