...
For what each option does, see the [configuration options reference](/docs/configure#options). To set up TurboSnap in the first place, see [Setup](/docs/turbosnap/setup).
