...
Note the Chromatic build URL, the specific test URL, and which browsers fail. A failure in Firefox or Safari but not Chrome points at timing more often than at logic.
...
If it fails locally too, you have an ordinary test bug and the rest of this guide won't help.
...
## 5. Handle timing and asynchrony
