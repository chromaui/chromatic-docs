...
**[Automate Chromatic with CI](/docs/ci)**

Integrate Chromatic into your continuous integration (CI) pipeline to get notified about any visual changes introduced by a pull request. Chromatic runs test any time you push code and reports changes via the “UI Tests” badge for your pull request.
