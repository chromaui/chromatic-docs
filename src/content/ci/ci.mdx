...
The way to fix this is to set the Chromatic [environment variables](/docs/faq/environment-variables): `CHROMATIC_SHA`, `CHROMATIC_BRANCH`, `CHROMATIC_SLUG`. Note that you must set all three.
