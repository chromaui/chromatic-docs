          ...
          - job: Vitest
            ...
            steps:
              ...
              - task: PublishPipelineArtifact@1
                inputs:
                  # Chromatic automatically defaults to the .vitest/chromatic directory.
                  # Replace with the path to your custom directory and adjust the CHROMATIC_ARCHIVE_LOCATION environment variable accordingly.
                  targetPath: .vitest/chromatic
                  artifact: chromatic-archives
          ...
          - job: Chromatic
            ...
            steps:
              ...
              - task: DownloadPipelineArtifact@2
                inputs:
                  buildType: "current"
                  artifactName: "chromatic-archives"
                  targetPath: "$(System.DefaultWorkingDirectory)/.vitest/chromatic"
              - task: CmdLine@2
                displayName: "Run Chromatic"
                inputs:
                  script: npx chromatic --vitest
                env:
                  CHROMATIC_PROJECT_TOKEN: $(CHROMATIC_PROJECT_TOKEN)
      ...
      - stage: UI_Tests
        ...
        jobs:
          - job: Cypress
            ...
            container: cypress/browsers:node-24.20.0-chrome-152.0.7977.64-1-ff-155.0-edge-152.0.4191.53-1
            variables:
              npm_config_cache: $(Pipeline.Workspace)/.npm
            steps:
              - checkout: self
