...
You should debug the archive locally if you suspect that a Vitest, Playwright, or Cypress project issue is related to the Chromatic archive **not being generated** or being generated **incorrectly**.
...
2. Run your tests as you normally would (using Vitest, Playwright, or Cypress) and then run the new script:
