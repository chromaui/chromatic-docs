...
Another option is incrementing the building time using environment variables for Storybook and Chromatic: `STORYBOOK_BUILD_TIMEOUT` and `CHROMATIC_TIMEOUT`. You can learn more about setting Chromatic environment variables here: [Environment variables](/docs/faq/environment-variables).
