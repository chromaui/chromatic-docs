...
| Vitest      | Serve resources from your local application server. If resources must come from another domain, add the domain to `assetDomains` in your [Chromatic configuration for Vitest](/docs/vitest/configure).                                                                                                                                                                                                |
