...
Chromatic E2E Visual Tests let you bring Chromatic's visual testing toolkit into your existing Cypress workflow. You can use Chromatic to capture snapshots of pages visited during Cypress tests—including DOM, styles, and assets—and then review and approve them in the Chromatic UI.
...
![Cypress visual test results as seen in the Chromatic UI](../../../images/e2e-playwright-build.png)
...
![Cypress manual snapshot as seen in the Chromatic UI](../../../images/e2e-playwright-library.jpg)
...
![Cypress manual snapshot as seen in the Chromatic UI](../../../images/e2e-playwright-manual.jpg)

---

## Next: Catch UI bugs using Cypress & Chromatic

📸 Now that you've set up Chromatic to capture snapshots of Cypress tests, let's explore how [visual tests](test) can help catch bugs.
