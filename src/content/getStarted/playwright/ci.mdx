...
Integrate with popular CI tools like you would any other job. Run `npm run chromatic` to run [visual tests](/docs/playwright/test). It will return a non-zero exit code when there are changes. For example:
