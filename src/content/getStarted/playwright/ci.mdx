...
import TroubleshootingCI from "../../shared-snippets/troubleshooting-ci.md";
...
Now that you've set up Chromatic, learn the recommended workflow in development and during the pull request. Altneratively, you can learn about more advanced configuration options available to you.

<a class="btn primary round" href="/docs/in-development">
  Learn workflow
</a>

<a class="btn outline round" href="configure">
