...
Next up, explore the advanced configuration options to tailor the Chromatic and Playwright setup to your needs.

<a class="btn primary round" href="/docs/playwright/configure">
