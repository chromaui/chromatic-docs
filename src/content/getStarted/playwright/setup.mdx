...
No. Playwright is a form of black box testing, which means it tests your app after the code is built. TurboSnap works by monitoring which files changed in the code, this isn't possible with black box testing.
