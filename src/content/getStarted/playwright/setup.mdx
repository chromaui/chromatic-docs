...
While your Playwright tests are running, Chromatic captures an archive of your app's UI for each test—DOM, styling, and assets included. When you execute the `chromatic` command, it uploads this archive to Chromatic's cloud infrastructure to capture a snapshot of each test.
...
![Playwright snapshots as seen in the Chromatic UI](../../../images/e2e-playwright-library.jpg)
