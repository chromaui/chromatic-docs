...
Chromatic enables Teams when it configures SSO and directory sync for your account. If you already use directory sync, complete [step 3](#3-send-the-configuration-to-chromatic-support) before syncing new groups.
...
Two defaults cover users and projects that mappings don't explicitly address. Both are configured by Chromatic on request (see [step 3](#3-send-the-configuration-to-chromatic-support)).
