...
4. **Base project role:** The role all organization users are granted for every project.
...
| **Billing** | Full access to billing management (invoices, payment methods, subscription). Intended for finance team members who manage payments but do not need full administrative access. Project access is determined by team membership or direct assignment. |
