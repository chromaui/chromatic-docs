...
| **playwright**<br/>`--playwright`                               | Use your Playwright tests to power visual tests with Chromatic. [Learn more](/docs/playwright/setup)                                                                                        | `boolean`               | `true`                               | `false`                   |
| **cypress**<br/>`--cypress`                                     | Use your Cypress tests to power visual tests with Chromatic. [Learn more](/docs/cypress/setup)                                                                                              | `boolean`               | `true`                               | `false`                   |
