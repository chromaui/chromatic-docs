...
| [`vitest`](#vitest), [`playwright`](#playwright), and [`cypress`](#cypress),                                  | These are mutually exclusive execution modes. A build runs with [Vitest](/docs/vitest), [Playwright](/docs/playwright), or [Cypress](/docs/cypress), never a combination of them.                                                                                                                                                                |
