...
<Tabs>
  <TabItem label="yarn">
    ```shell
    yarn dlx chromatic@latest init -f playwright
    ```
  </TabItem>

  <TabItem label="npm">
    ```shell
    npx chromatic@latest init -f playwright
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="yarn">
    ```shell
    yarn dlx chromatic@latest --playwright -t=<TOKEN>
    ```
  </TabItem>

  <TabItem label="npm">
    ```shell
    npx chromatic@latest --playwright -t=<TOKEN>
    ```
  </TabItem>
</Tabs>
