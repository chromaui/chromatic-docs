...
When using Chromatic with Storybook, you can control how a snapshot is captured via Storybook [parameters](https://storybook.js.org/docs/writing-stories/parameters) and [globals](https://storybook.js.org/docs/essentials/toolbars-and-globals#globals).
...
| `chromatic.cropToViewport`          | `boolean`  | Crop the screenshot to the viewport, [learn more](/docs/modes/viewports#cropping-viewports)                                             |
