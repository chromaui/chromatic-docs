...
<Tabs>
  <TabItem label="yarn">
    ```shell
    yarn add --dev chromatic @chromatic-com/cypress @storybook/addon-essentials@next @storybook/server-webpack5@next storybook@next
    ```
  </TabItem>

  <TabItem label="npm">
    ```shell
    npm install --save-dev chromatic @chromatic-com/cypress @storybook/addon-essentials@next @storybook/server-webpack5@next storybook@next
    ```
  </TabItem>
</Tabs>
