...
Support for the GitHub Action is currently in flux and this interface will likely change, but for now you can use the following configuration:
...
<div class="aside">
  Note: with the GitHub Action, if you're using npm as your package manager, you will also need to add the following to `scripts` in `package.json`:
  ```json
    "scripts": {
