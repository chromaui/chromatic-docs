...
From there, write your Cypress tests as you normally would. Chromatic will automatically take a snapshot at the end of each test, and upload them to the Chromatic cloud for review.
