...
<Tabs>
  <TabItem label="yarn">
    ```shell
    yarn dlx chromatic@latest init -f cypress
    ```
  </TabItem>

  <TabItem label="npm">
    ```shell
    npx chromatic@latest init -f cypress
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="yarn">
    ```shell
    yarn dlx chromatic@latest --cypress -t=<TOKEN>
    ```
  </TabItem>

  <TabItem label="npm">
    ```shell
    npx chromatic@latest --cypress -t=<TOKEN>
    ```
  </TabItem>
</Tabs>
