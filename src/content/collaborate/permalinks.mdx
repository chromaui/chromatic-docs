...
If you're currently subscribed to a free or open-source plan in Chromatic, you can set up a custom URL redirect in your hosting provider to point to the permalink provided by Chromatic.
If you're subscribed to one of the premium plans, please take a look at the instructions below on how to set up a customain domain.
