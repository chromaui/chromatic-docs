...
Chromatic supports Playwright 1.38.0 and above.
...
Chromatic creates and runs a Storybook archive based on your Playwright project, so the build Storybook step is required. Chromatic doesn't run Playwright directly.
