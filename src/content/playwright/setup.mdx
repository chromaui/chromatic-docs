...
<div class="callout">
  ...
  Chromatic project to run visual tests with Playwright. Follow the instructions for [sub-projects
...
<div class="aside">Chromatic only works with tests written in Playwright v1.12+.</div>
...
- [**Responsive testing:**](/docs/viewports#playwright) Verify your UI's responsiveness across various screen sizes. Easily configure viewport dimensions in Playwright, both globally and within individual tests.
