...
Chromatic supports Cypress 13.5.0 and above.
...
Chromatic creates and runs a Storybook archive based on your Cypress project, so the build Storybook step is required. Chromatic doesn't run Cypress directly.
