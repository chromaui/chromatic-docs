---
title: Why Chromatic?
description: Chromatic is a cloud-based toolchain that integrates with Storybook, Vitest, Playwright, and Cypress to help teams test and review UIs.
sidebar: { order: 1 }
isHome: true
slug: introduction
---
...
Chromatic is made by the [team](https://www.chromatic.com/company/about) behind Storybook and integrates with Storybook, Vitest, Playwright, and Cypress.
...
- [**Accessibility tests**](/docs/accessibility): run axe on each component to identify accessibility violations and get remediation tips.
...
🤖 **Higher codegen quality**: [Storybook MCP](/docs/mcp) improves AI agent output by providing it with better context about your components. Chromatic simplifies the process hosting your Storybook MCP server with proper authentication and access control.

## Powered by your existing tests

Chromatic's UI Tests build on the Storybook, Vitest, Playwright, and Cypress tests you’ve already written. This dramatically reduces maintenance burden and setup.
...
### <img src="/docs/assets/vitest.svg" class="inline-icon" alt="" /> Vitest

Chromatic works alongside your existing Vitest component tests. As each test runs, it captures an archive of your UI (DOM, styles, and assets), then renders that archive in cloud browsers and pixel-diffs the snapshots to find visual changes.
...
<div class="btn-integration-group">
  ...
  <a class="btn-integration" href="/docs/vitest" title="Vitest">
    <img src="/docs/assets/vitest.svg" alt="" />
  </a>
