...
# Test how UIs look & function with Chromatic

Chromatic is a UI testing tool that scans every possible UI state across browsers to catch bugs in appearance and functionality, and accessibility violations. It enables you to assign reviewers and resolve discussions to streamline team sign-off.
...
Chromatic executes three types of UI Tests:
...
- [**Accessibility tests**](/docs/interactions) (coming soon): runs Axe on each component to capture accessibility violations and their corresponding DOM nodes

find regressions instantly, making compliance a natural part of your team’s workflow.
