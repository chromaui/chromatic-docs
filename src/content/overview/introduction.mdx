...
### <img src="/docs/assets/storybook.svg" class="inline-icon" alt="" /> Visual testing with Storybook
...
[**Get started with Storybook & Chromatic »**](/docs/storybook/setup)

### <img src="/docs/assets/playwright.svg" class="inline-icon" alt="" /> Visual testing with Playwright
...
[**Get started with Playwright & Chromatic »**](/docs/playwright/setup)

![](../../images/workflow-e2e-visual-test.png)

### <img src="/docs/assets/cypress.svg" class="inline-icon" alt="" /> Visual testing with Cypress
...
[**Get started with Cypress & Chromatic »**](/docs/cypress/setup)
...
<div class="btn-integration-group">
  <a class="btn-integration" href="/docs/storybook" title="Storybook">
