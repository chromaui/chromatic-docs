...
- [**CLI:**](/docs/cli) Run Chromatic’s UI tests via CLI, and review test results in the Chromatic web app.
- [**Visual Tests Addon:**](/docs/visual-tests-addon) Streamline your testing workflow by triggering visual tests and viewing results without leaving Storybook.

You can also automate Chromatic to run for every PR by integrating it into your CI pipeline. [Learn more about automating Chromatic’s UI tests »](/docs/ci).
