...
<div class="aside">
  ℹ️ Not using Storybook? Chromatic integrates with [Playwright](/docs/playwright) and [Cypress](/docs/cypress) transform your E2E tests into visual regression tests.
</div>
...
[**Integrate Chromatic into your CI pipeline**](/docs/ci) to get notified about any visual changes introduced by a pull request. Chromatic will run tests any time you push code and reports changes via the “UI Tests” badge for your pull request.
