...
<div class="aside">
  ℹ️ Not using Storybook? Chromatic integrates with [Playwright](/docs/playwright) and
  [Cypress](/docs/cypress) to transform your E2E tests into visual regression tests.
</div>
