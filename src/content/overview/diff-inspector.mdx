...
Diff Inspector is a tool in the Chromatic web app that helps you see what visually changed between a test baseline and new snapshot. Changed areas are automatically highlighted in neon green for immediate visibility.

![](https://chromaticblog.ghost.io/content/images/downloaded_images/Diff-Detector-2-0/1-dB-pr5dfHUiQ76KtwoJlSA.png)
...
![1up vs 2Up](https://placehold.co/600x400?text=1up+vs+2up)
...
![1up vs 2Up](https://placehold.co/600x400?text=highlight+ignored+regions)
