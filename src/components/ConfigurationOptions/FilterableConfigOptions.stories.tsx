...
export const FilterOptions: Story = {
  ...
  play: async ({ canvas, userEvent }) => {
    ...
    await userEvent.click(await screen.findByRole('menuitemcheckbox', { name: 'CLI' }));

    await userEvent.click(FilterButton);
    await userEvent.click(await screen.findByRole('menuitemcheckbox', { name: 'GitHub Action' }));
  },
};
...
export const NoOptions: Story = {
  ...
  play: async ({ canvas, userEvent }) => {
    ...
    await userEvent.click(FilterButton);
    await userEvent.click(await screen.findByRole('menuitemcheckbox', { name: 'Config File' }));
  },
};
